...
- **Загрузка изображений** из URL (с автоматическим обходом CORS)
- **Простой маппинг** по именам слоев
- **Множественное заполнение** — выберите несколько фреймов и заполните их случайными данными
- **Надежная загрузка** — автоматический fallback для изображений при проблемах с CORS
...
- [Решение проблем с изображениями](./docs/IMAGE_LOADING_TROUBLESHOOTING.md) ⚠️
